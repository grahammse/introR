...
```{r echo = FALSE}
data.frame(
  Name = c("mean", "median", "sd", "var", "max", "min", "rank", "log", "exp", "round", "cor"),
  Operation = c("Mean", "Median", "Standard Deviation", "Variance", "Largest Element", "Smallest Element", "Rank of Elements", "Natural Log", "Exponential", "Round to n Decimal Places", "Correlation")) %>% 
  kable(format = "html") %>% 
